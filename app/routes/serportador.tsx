      ...
      <div className="grid lg:grid-cols-2 gap-8 items-start">
        ...
        <div className="relative">
          <img
            ...
            className="w-full h-[280px] sm:h-[360px] md:h-[480px] lg:h-[600px] object-cover rounded-2xl shadow-xl"
            loading="eager"
          />
        ...
        <div className="space-y-6">
          ...
          <p className="text-sm sm:text-base md:text-lg leading-relaxed text-gray-900 font-body">
          ...
          <p className="text-sm sm:text-base md:text-lg leading-relaxed text-gray-900 font-body">
            Envia un correo a nuestro capataz:
          </p>

          {/* Caja de contacto: correo centrado + botón copiar a la derecha */}
          <Card className="bg-emerald-50 text-emerald-900 ring-1 ring-emerald-200 px-4 py-5 min-h-[100px] grid grid-cols-[1fr_auto] items-center gap-4">
            <p className="text-xs sm:text-sm md:text-base leading-relaxed font-medium break-all justify-self-center text-center text-emerald-900">
              {config.portersEmail}
            </p>
            <CopiableText
              variant="icon-only"
        ...
        <div className="space-y-3">
          ...
          <ul className="list-disc pl-5 space-y-2 text-sm sm:text-base">
            ...
            <li>
              ...
              pajarita negros) y mantener una presentación adecuada.
            </li>
            <li>
            ...
            <li>
              ...
              fraternidad, dentro y fuera del paso.
            </li>
          </ul>
        </div>
